	...
	<header class="top-navbar">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <li class="nav-item {{(Request::path() === '/') ? 'active' : ''}}"><a class="nav-link" href="/">Home</a></li>
						<li class="nav-item {{(Request::path() === 'clients') ? 'active' : ''}}"><a class="nav-link" href="/clients">Clients</a></li>
						<li class="nav-item {{(Request::path() === 'about') ? 'active' : ''}}"><a class="nav-link" href="/about">About</a></li>
						<li class="nav-item {{(Request::path() === 'carrier') ? 'active' : ''}}"><a class="nav-link" href="/carrier">Blog</a></li>
